...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', default='/data2/jys/.virtualenvs/Defend_MI-master/BiDO/target_model')
    ...
    if args.dataset == 'celeba':
        ...
        if args.defense == 'HSIC' or args.defense == 'COCO':
            ...
            if args.defense == 'MI' or args.defense == 'MI+DP':
                ...
                if args.defense == "vib":
                    path_T_list = [
                        os.path.join(args.model_path, args.dataset,  "VGG16_vib_beta0.000_84.94.tar"),
                        os.path.join(args.model_path, args.dataset,  "VGG16_vib_beta0.005_73.87.tar"),
                        os.path.join(args.model_path, args.dataset, "VGG16_vib_beta0.010_66.12.tar"),
                    ]
                    ...
                    path_T = os.path.join(args.model_path, args.dataset, args.defense, "VGG16_reg_86.57.tar")
