...
mnist_path ="/home/jys/.virtualenvs/Defend_MI/attack_dataset/MNIST/"#有temp
mnist_img_path = "/home/jys/.virtualenvs/Defend_MI/attack_dataset/MNIST"

cifar_path = "/home/jys/.virtualenvs/Defend_MI/attack_dataset/CIFAR/"
cifar_img_path = "/home/jys/.virtualenvs/Defend_MI/attack_dataset/CIFAR"
...
class ImageFolder(data.Dataset):#加载和处理 RGB 图像数据集
...
# 原来的
        ...
        #         proc.append(transforms.RandomHorizontalFlip(p=0.5))
        #     proc.append(transforms.ToTensor())
        #     # 关键修复：将数据从[0,1]归一化到[-1,1]，匹配生成器的Tanh输出
...
class GrayFolder(data.Dataset):#专用于 MNIST 等灰度图像数据集
    def __init__(self, args, file_path, mode):
        self.args = args
        self.model_name = args["dataset"]["model_name"]
        self.processor = self.get_processor()
...
class celeba(data.Dataset):#处理 CelebA 数据集，支持属性分类任务
...
def load_cifar10():#下载 CIFAR-10 数据集
    transform = transforms.Compose([transforms.ToTensor()])
