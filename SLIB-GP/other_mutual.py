...
#             train_loss, train_acc = engine.train_mutual(net, criterion, optimizer, trainloader, a1, a2, n_classes,
#                                                       ktype=args.ktype,
#                                                       hsic_training=args.hsic_training)
#             test_loss, test_acc = engine.test_mutual(net, criterion, testloader, a1, a2, n_classes, ktype=args.ktype,
#                                                    hsic_training=args.hsic_training)
#
